...
public class FolderSettings : IDumper
{
    ...
    [Category(Files), Description("Source folder: where the Pokémon files are to distribute while the bot isn't trading.")]
    public string DistributeFolder { get; set; } = string.Empty;

    [Category(Files), Description("Destination folder: where all received Pokémon are saved to.")]
